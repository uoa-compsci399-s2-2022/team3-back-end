...
# Email
# ------------------
EMAIL_ACCOUNT='088e6bde11700767e12c8a29dd7e48b9'
EMAIL_PASSWORD='9689443f96ca0738c85364d9dca0876a'
EMAIL_SENDER_ADDRESS='no-reply@uoamtms.com'
EMAIL_SERVER_HOST='in-v3.mailjet.com'
EMAIL_SERVER_PORT=587
EMAIL_SERVER_SSL_PORT=465
EMAIL_SENDER_NAME="UoA-MTMS"
''')
        env.close()
